...
//    [self.showImage setImageViewAssignmentURL:[NSString stringWithFormat:@"%@%@", kSHY_100,model.goods_image] image:[UIImage imageNamed:@"zly"]];
//    self.nameLabel.text = model.goods_name;
//    self.priceLabel.text = model.goods_store_price;
}
